...
import type { Payment, Tab, User } from './types';
...
const currentUser: User = {
  ...
  photoURL: `https://lh3.googleusercontent.com/a-/ALV-UjWiss3i9…ulVyt1cXCFrwiXJKsrGzleuAf_I4wn8kgA=s300-p-k-rw-no`,
};
  ...
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-800 flex flex-col">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <h1 className="text-xl font-bold text-blue-700">Mitsubishi Xpander (VPN1968) Loan Tracker</h1>
            </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 shadow-t-md flex justify-around">
         ...
         <NavItem tab="profile" label="Profile" icon={<UserIcon active={activeTab === 'profile'} />} />
      </nav>
    </div>
  );
};
